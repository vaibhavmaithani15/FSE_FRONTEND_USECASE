...
function OrderCard() {
  ...
  return (
    <div onClick={()=>navigate(`/account/order/${5}`)} className='p-5 shadow-lg hover:shadow-2xl border mt-5'>
        <Grid container spacing={2} sx={{justifyContent:"space-between"}}>
            <Grid item sx={6}>
                <div className='flex cursor-pointer'>
                    ...
                    <div className='ml-5 space-y-2'>
                            <p className=''>Men Regular Mid Rise Black Jeans</p>
            ...
            <Grid item xs={4}>
                ...
                {false && <p>
                    <span>Excepted Delivery On March 03</span>
                </p>}
