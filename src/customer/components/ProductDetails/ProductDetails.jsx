      ...
      <div className="pt-6">
        ...
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className='opacity-50 text-sm'>4631 Ratings</p>
            <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>899 Reviews</p>
              </div>
            </div>
            ...
            <Grid container spacing={7}>
             ...
             <Grid item xs={5}>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <p className='opacity-60'>593233 Ratings</p>
              </div>
